...
public class FacebookHandle {
	...
	private FBHandleListener listener;
...
*/
    ...
    */
	...
	public static interface FBHandleListener {
	...
	public FBHandleListener getListener() {
		return listener;
	}

	public void setListener(FBHandleListener listener) {
